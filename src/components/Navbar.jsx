        ...
        <div className="max-width-container h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link
              ...
              className={`text-[14px] font-medium transition-colors font-body ${
                location.pathname === '/blog' ? 'text-green-primary' : 'text-text-secondary hover:text-text-primary'
              }`}
            >
              Blog
            </Link>
            ...
            >
              <div className="flex flex-col gap-5 px-6 py-6 font-body">
                <Link
                  ...
                  aria-current={location.pathname === '/blog' ? 'page' : undefined}
                  className={`text-base font-medium py-1.5 transition-colors border-b border-border/40 ${
                    location.pathname === '/blog' ? 'text-green-primary' : 'text-text-secondary hover:text-text-primary'
                  }`}
                >
                  Blog
